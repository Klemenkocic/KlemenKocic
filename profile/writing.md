...
**Key framework:** The scarcity migration — as AI makes execution cheap, the valuable layer shifts from production to intent, taste, and commitment. The people who can name what matters (and what doesn't) become the bottleneck.

**Best quote:** "When agents raise the standard, they erase the old signal that 'good work' once carried — and scarcity migrates upward, from making things to deciding which things deserve to exist."
...
**Key framework:** Permit → Equip → Audit. Three operational layers that turn "we use AI" from a vague aspiration into a managed capability with governance.

**Best quote:** "Using AI at work is not cheating — when it is used to augment human judgment and capability, not replace it."
...
**Key framework:** The Augmentation Arc — four modes of human-AI interaction: Mirror (reflects what you bring), Lens (focuses and sharpens), Lighthouse (illuminates what you couldn't see), and Prism (refracts into unexpected directions). Most people stay stuck at Mirror.

**Best quote:** "Bring vague questions and thin knowledge, and AI will upscale your vagueness."
...
**Key framework:** From bicycle (individual amplification) to yacht (collective coordination). AI augmentation at the organisational level requires turning ambient signals into strategic advantage — reading the environment as a team, not optimising tasks as individuals.

**Best quote:** "Leaders need to think less like cyclists and more like sailors."
