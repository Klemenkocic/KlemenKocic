...
We did an audit last week. Went through every agent session log from the past two months. Looked at what emerged — behaviours, patterns, capabilities that nobody explicitly designed.

We found ten. Ten emergent behaviours across the system.
...
The cycle we've landed on is: emerge, capture, formalise. The system produces something unexpected. The human catches it. Then together they turn it into something the system can use going forward.

You can't automate the catching part. That's the whole point.
